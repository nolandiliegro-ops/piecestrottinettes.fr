CREATE OR REPLACE FUNCTION public.sync_part_image_url()
RETURNS TRIGGER
LANGUAGE plpgsql
...
DROP TRIGGER IF EXISTS trg_sync_part_image_url ON public.parts;

CREATE TRIGGER trg_sync_part_image_url
BEFORE INSERT OR UPDATE OF images, image_url ON public.parts
FOR EACH ROW
EXECUTE FUNCTION public.sync_part_image_url();
