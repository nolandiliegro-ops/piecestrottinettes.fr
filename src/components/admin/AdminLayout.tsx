...
import { LayoutDashboard, Package, Users, ScanLine, MessageSquare, Settings, ArrowLeft, Shield, Palette, Sparkles } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { id: 'home-bridge', icon: Sparkles, label: 'Bridge' },
