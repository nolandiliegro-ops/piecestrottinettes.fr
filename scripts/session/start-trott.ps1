# start-trott.ps1
# Demarrage de session de dev sur piecestrottinettes.fr
# Pull origin/main puis lance Claude Code
...
function Write-Header {
    ...
    Write-Host "  STEEDY DEV  -  DEMARRAGE DE SESSION" -ForegroundColor Cyan
    Write-Host "================================================================" -ForegroundColor Cyan
    Write-Host ""
...
try {
    ...
    Write-Host "         Resous le conflit puis relance start-trott." -ForegroundColor Red
    exit 1
}
